package proyectos_poo.poo_basico.herencia_abstraccion_interfaces.GestionPersonasUniversidad.services;
...
public class ServicioPersona {
     ...
     * </p>
     *
     * @param personasEn la persona a agregar (no puede ser null)
    ...
    public void add(Persona personasEn) {
        ...
        if (indice >= tamanioArr) {
            throw new IllegalStateException("⚠️ No se puede agregar el " + personasEn.getTipoPersona() + " = " + personasEn.getNombre() + " Capacidad: "
